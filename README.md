...
Run the project - it should work out of the box
Read this README to understand the architecture
Start building your game features!
...
gdscript# These are autoloaded - available everywhere as global variables
...
gdscript# Examples of using GameManager
...
gdscript# Get movement as Vector2
...
gdscript# HealthComponent.gd - Can be used by player, enemies, destructible objects
extends Node
...
gdscript# Good resource organization
...
gdscript# Check if resources exist
...
gdscript# Instead of instantiating bullets constantly
...
Create script in scripts/managers/
...
Create scene in appropriate folder (scenes/Game/ or scenes/Components/)
Attach script in scripts/entities/ or scripts/components/
Use existing components when possible
Emit events for important state changes

Adding UI Elements

Create scene in scenes/UI/
Attach script in scripts/ui/
Connect to EventBus for game state updates
Use tweens for animations

🐛 Debugging Tips
Using the EventBus for Debugging
Add debug prints to EventBus connections:
gdscriptfunc _on_player_health_changed(health: int, max_health: int):
    print("DEBUG: Player health: ", health, "/", max_health)
Manager State Inspection
Add debug methods to managers:
gdscript# In GameManager
...
Comments
gdscript# Use comments to explain WHY, not WHAT
...
Choose a simple feature (e.g., collecting coins)
...
Understand the feature you're implementing
...
Document new events or public functions

Before Committing

Test the entire game flow
...
[Understanding Component Systems](https://docs.godotengine.org/)
[Event-Driven Programming](https://docs.godotengine.org/en/stable/getting_started/step_by_step/signals.html)
[State Management Patterns](https://docs.godotengine.org/en/stable/tutorials/best_practices/scene_organization.html)
